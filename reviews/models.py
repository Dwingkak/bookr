...
class Publisher(models.Model):
    ...
    name = models.CharField(max_length=50, help_text="The name of the Publishers.")
...
class Contributor(models.Model):
    ...
    last_names = models.CharField(max_length=50, help_text="The contributors's  last names or names.")
...
class Review(models.Model):
    ...
    date_created = models.DateTimeField(help_text="The date and time the review was created.")
    ...
    def __str__(self):
        rating = self.rating * "*"
        return f"{self.book.title} {rating}"
